    ...
    if (isset($_POST["add_to_cart"])) {
        ...
        // } else {
            $query_e = mysqli_query($con, "INSERT INTO `tbl_cart`(`cart_user_id`, `cart_book_id`, `cart_book_name`, `cart_book_image`, `cart_book_price`,`cart_pdf_price`,`cart_cd_price`, `cart_book_quantity`) VALUES ('$user_id','$book_id','$book_name','$book_image','$book_price','$pdf_price','$cd_price','1')");
