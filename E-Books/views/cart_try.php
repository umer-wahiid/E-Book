                ...
                <div class="col-md-10 col-11 mx-auto">
                    <div class="row mt-5 gx-3">
                        ...
                        <div class="col-md-12 col-lg-8 col-11 mx-auto main_cart mb-lg-0 mb-5 shadow">
                            ...
                            $fetch_book = mysqli_query($con, 'SELECT * FROM tbl_cart where `cart_user_id` = "$userid"
                            -- INNER JOIN tbl_book_detail as tb1
                            -- ON
                            -- tbl_cart.cart_book_name = tb1.book_title
                            -- INNER JOIN tbl_book_detail as tb2
                            -- ON
                            -- tbl_cart.cart_book_image = tb2.book_image
                            -- INNER JOIN tbl_book_detail as tb3
                            -- ON
                            -- tbl_cart.cart_book_price = tb3.book_price_hardcopy
                            ');
                                    ...
                                    <div class="col-md-7 col-11 mx-auto px-4 mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-6 card-title">
                                                <h1 class="mb-4 product_name">'.$row[0].'</h1>
